...
local t = Def.ActorFrame {
	...
	NOTESKIN:LoadActor( Var "Button", "Realistic Explosion" ) .. {
        InitCommand=function(self)
			self:SetStateProperties(Sprite.LinearFrames(64,(64/60)));
			self:diffusealpha(0);
		end;
		HitMineCommand=function(self)
			self:blend("BlendMode_Normal"):diffusealpha(1.0):zoom(0.75):accelerate(0.96):diffusealpha(0.0):zoom(1.0):setstate(0):animate(true)
		end;
	};
}
return t;